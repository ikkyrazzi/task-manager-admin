...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('_admins.profile.edit_profile') }}" class="btn btn-primary me-2">Edit Profile</a>
                <a href="{{ route('_admins.profile.change_password') }}" class="btn btn-warning">Change Password</a>
            </div>
        </div>
        <div class="card-body">
